...
//  - The assembly keyword in the second gate allows a contract to access functionality that is not native to vanilla Solidity. See here for more information.
...
//      - https://docs.soliditylang.org/en/v0.4.23/assembly.html
...
//      - https://docs.soliditylang.org/en/v0.4.23/miscellaneous.html#cheatsheet
